...
In this case, a water level of 40 would lead to a flow rate of around 2. 
To set a maximum flowrate regardless of level, add an extra row with the identical (maximum) flow rate:
